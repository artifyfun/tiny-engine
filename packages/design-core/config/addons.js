...
import Workflow from '@opentiny/tiny-engine-plugin-workflow'
...
const addons = {
  plugins: [Materials, Tree, Page, Block, Datasource, Bridge, I18n, Script, Data, Workflow, Schema, Help, Robot],
  toolbars: [
    Logo,
    Breadcrumb,
    Media,
